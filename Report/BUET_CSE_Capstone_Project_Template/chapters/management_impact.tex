...
\Cref{tab:partner-req} is the artefact of that engagement, and the eleven
...
ETA-TR-2026-001 is the partner's work, not the team's, and is reproduced in
\Cref{app:etatr} with their knowledge so that the requirement identifiers used
throughout this report can be checked against their source rather than taken on
trust. It is not otherwise published. Its authorship rests with Samsung
Research and Development Institute Bangladesh, and nothing in the licence of
\Cref{sec:ip} extends to it.
