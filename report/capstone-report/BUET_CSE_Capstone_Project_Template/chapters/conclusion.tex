...
\begin{xltabular}{\textwidth}{@{}>{\hsize=0.42\hsize}Y>{\hsize=1.40\hsize}Y>{\hsize=1.18\hsize}Y@{}}
  ...
  O3 Autonomous execution on two platforms with three-way attribution &
    ...
    Met in capability. \guidance{TODO (ch.5): insert the measured autonomy rate from \Cref{ch:evaluation} and state plainly whether the campaign target was reached.} \\
  \addlinespace
  ...
  O7 Measured cost within budget &
    ...
    Met. \guidance{TODO (ch.5): insert the final cost-per-test figure and the billing reconciliation from \Cref{ch:evaluation}.} \\
  \addlinespace
  O8 Operator surface &
...
\guidance{TODO (ch.5): revisit this whole section once \Cref{ch:evaluation} is
