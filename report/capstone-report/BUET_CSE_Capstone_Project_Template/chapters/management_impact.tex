...
\begin{xltabular}{\textwidth}{@{}>{\hsize=0.52\hsize}Y>{\hsize=0.42\hsize}Y>{\hsize=1.32\hsize}Y>{\hsize=0.24\hsize}Y@{}}
  ...
  Niloy Kumar Mondal (2105044) &
    ...
    Surveyed fifteen recent related works and assessed each for relevance, which is the material behind \Cref{subsec:additional}. Carried out the structured internal code review against an explicit severity rubric that is referred to in \Cref{sec:accountability}. Built the downloadable PDF run report with its generated narrative (DR-08) and corrected its long-report generation. Ran testing against the second target. &
    Yes \\
\end{xltabular}
\endgroup
