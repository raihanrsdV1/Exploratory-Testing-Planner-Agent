...
\guidance{TODO (team): the three works cited in this subsection were surveyed
from their published abstracts and metadata by a team member, not read in full
by the author of this chapter, and their \texttt{references.bib} entries use
first-author-et-al form. Verify all three against the published versions before
submission, and either read the visual-grounding and survey works and cite them
properly or leave them uncited as they are here.}
